  ...
  return (
    <div className="container mt-4">
      ...
      <div className="profile-container d-flex mt-4 p-3 bg-white rounded shadow">
        <img src="https://cdn.jsdelivr.net/npm/bootstrap-icons/icons/person-circle.svg" alt="Profile Icon" style={{ width: 150, height: 150 }} />
        <div className="ml-4">
          ...
          <button className="btn btn-primary mt-2" onClick={() => window.location.href = "/edit-profile"}>Edit Profile</button>
        </div>
      </div>

      <div className="mt-4">
        <button className="btn btn-success" onClick={() => window.location.href = "/vote"}>Vote Now</button>
      </div>
    </div>
  );
}
